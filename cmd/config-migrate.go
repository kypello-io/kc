...
func migrateConfigV2ToV3() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V2.")
...
func migrateConfigV3ToV4() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V3.")
...
func migrateConfigV4ToV5() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V4.")
...
func migrateConfigV5ToV6() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V5.")
...
func migrateConfigV6ToV7() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V6.")
...
func migrateConfigV7ToV8() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V7.")
...
func migrateConfigV8ToV9() {
	...
	fatalIf(probe.NewError(e), "Unable to load kc config V8.")
