...
```
go get -d github.com/kypello-io/kc
cd ${GOPATH}/src/github.com/kypello-io/kc
make
```
...
## 贡献
请遵守MinIO[贡献者指南](https://github.com/kypello-io/kc/blob/master/docs/zh_CN/CONTRIBUTING.md)
